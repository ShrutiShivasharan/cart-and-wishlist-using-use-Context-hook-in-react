...
function Cart() {
    ...
    const { cart, removeFromCart, clearCart, incrementQuantity, decrementQuantity } = useContext(StoreContext);
    ...
    const {  subTotal, gst, shipping, total } = calculationTotals();
                                ...
                                <div key={product.id} className="p-2">
                                    <div className='flex justify-between'>
                                        ...
                                        <div style={{ width: '60%', height: '60%' }}>
                                            ...
                                            <div className="mt-4 flex justify-between">
                                                <div className='flex justify-between'>
                                                    <button onClick={()=> incrementQuantity(product.id)} className="text-white bg-blue-500 p-2 mr-3 rounded ">+</button>
                                                    <p>Quantity - {product.quantity}</p>
                                                    <button onClick={()=> decrementQuantity(product.id)} className="text-white bg-pink-500 p-2 ml-3 rounded ">-</button>
                                                </div>
                                            </div>
                        ...
                        <div className='container'>
                            <div className='container'>
                                ...
                                <div className='flex p-5'>
                                    ...
                                    <strong><h1 className='ml-4 text-xl'><i class="fa-solid fa-rupee-sign"></i>. {total} </h1></strong>
                                </div>
                            </div>
                            <div className='my-2'>
